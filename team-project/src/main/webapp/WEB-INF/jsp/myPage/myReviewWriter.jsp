...
.starpoint_box{position:relative;background:(C:\Users\admin\Desktop\별\5 별) 0 0 no-repeat;font-size:0;}
.starpoint_box .starpoint_bg{display:block;position:absolute;top:0;left:0;height:18px;background:(C:\Users\admin\Desktop\별\0 별) -20px no-repeat;pointer-events:none;}
...
<div class="starpoint_wrap">
  <div class="starpoint_box">
    ...
    <input type="radio" name="rate" id="starpoint_1" class="star_radio" value ="0.5">
    <input type="radio" name="rate" id="starpoint_2" class="star_radio"value ="1.0">
    <input type="radio" name="rate" id="starpoint_3" class="star_radio" value ="1.5">
    <input type="radio" name="rate" id="starpoint_4" class="star_radio" value ="2.0">
    <input type="radio" name="rate" id="starpoint_5" class="star_radio" value ="2.5">
    <input type="radio" name="rate" id="starpoint_6" class="star_radio" value ="3.0">
    <input type="radio" name="rate" id="starpoint_7" class="star_radio" value ="3.5">
    <input type="radio" name="rate" id="starpoint_8" class="star_radio" value ="4.0">
    <input type="radio" name="rate" id="starpoint_9" class="star_radio" value ="4.5">
    <input type="radio" name="rate" id="starpoint_10" class="star_radio" value="5.0">
